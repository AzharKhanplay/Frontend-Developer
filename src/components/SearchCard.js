...
function SearchCard({ id, serial, type, status, last_update, handleClick }) {
  return (
    <article className="searchCard cursor-pointer rounded-xl border-2 mb-4 p-4 hover:bg-sky-100" onClick={handleClick} data-testid={`capsule-${id}`}>
