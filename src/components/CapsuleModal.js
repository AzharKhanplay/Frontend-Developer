...
function CapsuleModal({selectedCapsule, handleClick}) {
  ...
  <div className="modal-content bg-white rounded-lg border-2 border-opacity-20 max-w-[360px] md:max-w-[540px] relative shadow-2xl">
    ...
    <div className="modal-body p-3 pt-5 md:p-6">
        <div className=" overflow-auto pb-3">
           <table className='border min-w-full text-left rounded-md ' width="100%">
            ...
            <tr className='border-b border-2 hover:bg-gray-100 mb-3'>
              ...
              <td className='border-2 p-3 whitespace-normal break-words max-w-[300px]'> {selectedCapsule ? selectedCapsule.id : ""}</td>
            </tr>
            <tr className='border-b border-2 hover:bg-gray-100 mb-3'>
              <th className='border-r border-2 p-3'><span className="font-medium">Serial:</span></th>
              <td className='border-2 p-3 whitespace-normal break-words max-w-[300px]'> {selectedCapsule ? selectedCapsule.serial : ""}</td>
            </tr>
            <tr className='border-b border-2 hover:bg-gray-100 mb-3'>
              <th className='border-r border-2 p-3'><span className="font-medium">Type:</span></th>
              <td className='border-2 p-3 whitespace-normal break-words max-w-[300px]'> {selectedCapsule ? selectedCapsule.type : ""}</td></tr>
            <tr className='border-b border-2 hover:bg-gray-100 mb-3'>
              <th className='border-r border-2 p-3'><span className="font-medium">Status:</span></th>
              <td className='border-2 p-3 whitespace-normal break-words max-w-[300px]'> {selectedCapsule ? selectedCapsule.status : ""}</td></tr>
            <tr className='border-b border-2 hover:bg-gray-100 mb-3'>
              <th className='border-r border-2 p-3'><span className="font-medium">Land Landings:</span></th>
              <td className='border-2 p-3 whitespace-normal break-words max-w-[300px]'> {selectedCapsule ? selectedCapsule.land_landings : ""}</td>
            </tr>
            <tr className='border-b border-2 hover:bg-gray-100 mb-3'>
              <th className='border-r border-2 p-3'><span className="font-medium">Water Landings:</span></th>
              <td className='border-2 p-3 whitespace-normal break-words max-w-[300px]'> {selectedCapsule ? selectedCapsule.water_landings : ""}</td></tr>
            <tr className='border-b border-2 hover:bg-gray-100 mb-3'>
              <th className='border-r border-2 p-3'><span className="font-medium">Launches:</span></th>
              <td className='border-2 p-3 whitespace-normal break-words max-w-[300px]'><span>{selectedCapsule ? selectedCapsule.launches : ""}</span></td></tr>
            <tr className='border-b border-2 hover:bg-gray-100 mb-3'>
              <th className='border-r border-2 p-3'><span className="font-medium">Reuse Count:</span></th>
              <td className='border-2 p-3 whitespace-normal break-words max-w-[300px]'> {selectedCapsule ? selectedCapsule.reuse_count : ""}</td></tr>
            <tr className='hover:bg-gray-100 mb-3'>
              <th className='border-r border-2 p-3'><span className="font-medium">Last Update:</span></th>
              <td className='border-2 p-3 whitespace-normal break-words max-w-[300px]'> {selectedCapsule ? selectedCapsule.last_update : ""}</td></tr>
            </tbody>
           </table>
        </div>
    </div>
